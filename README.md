...
- [x] 목표 아키텍처와 주요 기술 결정 확정
  ...
  - 상세 문서: [TO-BE Architecture](docs/migration/04-to-be-architecture.md), [ADR-001](docs/migration/adr/ADR-001-initial-technical-decisions.md), [ADR-002 제거 시점 결정](docs/migration/adr/ADR-002-supabase-removal-timing.md), [ADR-003 목표 인프라 결정](docs/migration/adr/ADR-003-target-infrastructure.md)
