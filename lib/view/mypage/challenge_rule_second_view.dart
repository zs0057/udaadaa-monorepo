...
class ChallengeRuleSecondView extends StatefulWidget {
  const ChallengeRuleSecondView({super.key});

  @override
  State<ChallengeRuleSecondView> createState() =>
      _ChallengeRuleSecondViewState();
}

class _ChallengeRuleSecondViewState extends State<ChallengeRuleSecondView>
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      // 마이페이지로 돌아가기 (두 번 pop)
                      Navigator.of(context).pop(); // 현재 페이지
                      Navigator.of(context).pop(); // 첫 번째 페이지
                    },
                    child: Text(
                      "완료",
